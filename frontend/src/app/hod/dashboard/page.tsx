...
const mockStats = {
  ...
  teamMembers: (user: UserRole) => (user.role === "hod" ? 45 : 12),
};
...
export default function HODDashboard() {
  ...
  const scopeText = isHOD ? user.businessUnit : user.department;
      ...
      <div className="flex items-center justify-between">
        <div className="p-3">
          ...
          <p className="text-muted-foreground text-xs">
            {isHOD ? "Head of Department" : "Department Manager"} • {scopeText}
          </p>
        </div>
